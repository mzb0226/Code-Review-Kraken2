...
2. **Documentation**  
The repository includes a README and a separate manual. While the manual is detailed, important instructions are not centralized, which may make it harder for new users to follow the workflow.
